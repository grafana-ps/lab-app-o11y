...
>
> This entire directory (`old-appd-replace-method/`) and all of its contents are **deprecated**.
> It contains an older lab method originally designed around an AppDynamics migration path
> that we **no longer recommend**.
>
> For the current approach, refer to the parent directory's updated guides.
